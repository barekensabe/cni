   ...
   //FONCTION POUR AJOUTER UN NOUVEAU UTILISATEUR
    public function add() {
        ...
        if ($this->form_validation->run() == FALSE) {
          ...
          //  $data['NB_HEURES_PREVUES'] = $this->input->post('NB_HEURES_PREVUES');
            $data['profiles']=$this->Model->getList('adm_profiles');
            ...
            $donnee = array(
                ...
                //'ID_COLLABO_CREATEUR'=>$this->session->userdata('USER_ID')
                'PASSWORD'=>md5('12345')
            );
    ...
    function liste(){
        ...
        foreach ($users as $user) {
            ...
            $array['OPTIONS'] .= "<li><a href='" . base_url('cra/Taches/nouvelle/' . $user['CONNEXION_ID']) . "'>Créer une Tâche</a></li>";
            $array['OPTIONS'] .= "<li><a href='" . base_url('cra/Projet/Modifier/' . $user['CONNEXION_ID']) . "'>Modifier</a></li>";
                                        ...
                                        <div class='modal-dialog'>
                                            <div class='modal-content'>
                                                ...
                                                <div class='modal-body'>
                                                    <h5>Supprimer :<b>" . $user['CONNEXION_ID'] . "</b>?</h5>
                                                </div>

                                                <div class='modal-footer'>
                                                    <a class='btn btn-danger btn-md' href='" . base_url('Missions/supprimer/' . $user['CONNEXION_ID']) . "'>Supprimer</a>
